...
. Execute Gradle task 'hivemqExtensionZip' from Gradle to build the extension. (./gradlew hivemqExtensionZip )
. Move the file: "build/hivemq-extension/HelloWorldExtension-4.4.4.zip" to the directory: "HIVEMQ_HOME/extensions"
. Unzip the file.
. Start HiveMQ.
